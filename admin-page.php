    ...
    <nav class="navbar navbar-expand-lg navbar-white ">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarMenu">
          <ul class="navbar-nav font-weight-bold">
            ...
            <li class="nav-item">
                    <ul class="navbar-nav font-weight-bold">
                        <li class="nav-item">                <a href="tickets.php" class="nav-link"> all Massage </a>
...
");
   ...
   else{$sql = mysqli_query($con, "SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT home.id as idz,home.name as man,home.img, book.val,book.book, book.ad FROM `book` JOIN home WHERE book.id=home.id AND book.val=1)as x JOIN (SELECT * FROM book1 ) as p WHERE p.hid=x.idz) AS m JOIN users WHERE m.uid=users.id)as o WHERE o.uid=$name
